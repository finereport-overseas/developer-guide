...
```
The *classForConnection()* and *appearanceForConnection()* introduce two new classes: *Connection* and *BasicBeanPane<? extends Connection>*. We must implement these two before creating a new data connection.
...
public class DemoConnectionPane extends DatabaseConnectionPane<DemoConnection> {
    ...
    /**
     * Generate a new connection object based on the setting panel.
     * @return
     */
