...
public class TestAppExporter extends AbstractAppExporter {
    /**
     * We only need to implement this method, which is the one to execute the export process.
     * @param outputStream  
     * @param resultWorkBook Export is essentially turning this resultWorkBook into a file.
     * @throws Exception
     */
    @Override
...
public interface ExportExtensionProcessor extends Immutable {
     ...
     * @param filaName
     * @param isEmbed whether it is an embedded type
     * @return
     * @throws Exception
     */
...
```java
/**
 * Directly extend the default PDF exporter
 */
...
```java
/**
 * Default export logic is implemented inside DefaultExportExtension, and we only need to modify the PDF export part.
 */
...
```java
/**
 * Since the client doesn't download the file by browser, content-type is no longer needed.
 */
